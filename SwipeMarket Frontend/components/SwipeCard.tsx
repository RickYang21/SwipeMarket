                            ...
                            <div className="flex gap-1 mb-2">
                                {TIMEFRAMES.map(tf => (
                                    <button
                                        ...
                                        className={`px-2.5 py-1 rounded-lg text-[9px] font-semibold tracking-wide transition-all duration-150 ${
                                            timeframe === tf
                        ...
                        {isCrypto && cryptoMarket ? (
                            ...
                            <div className="mb-4">
                                ...
                                <div className="odds-bar">
                                    <div className="odds-bar-yes" style={{ width: `${market.yes_price * 100}%` }} />
                                </div>
                            </div>
                        )}
